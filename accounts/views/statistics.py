...
def statistics(request):
	...
	if not unit_slug:
		...
		data, library = statistics_chart(chart, unit, ledger)
		...
		data, library = statistics_chart(chart, unit, ledger, year=year)
	elif unit_slug and chart and year and month:
		unit = get_object_or_404(Unit, slug=unit_slug)
		option_name = None
		options = []
		data, library = statistics_chart(chart, unit, ledger, year=year, month=month)
	else:
		options = []
