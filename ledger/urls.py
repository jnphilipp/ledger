...
urlpatterns = patterns('',
	...
	url(r'^api/accounts/(?P<slug>[\w-]+)/charts/statistics/categories$', 'accounts.views.api.accounts.charts.statistics.categories', name='account_chart_statistics_categories'),
	url(r'^api/accounts/(?P<slug>[\w-]+)/charts/statistics/tags$', 'accounts.views.api.accounts.charts.statistics.tags', name='account_chart_statistics_tags'),
	url(r'^api/accounts/(?P<slug>[\w-]+)/charts/categories$', 'accounts.views.api.accounts.charts.categories.categories', name='account_chart_categories'),
	url(r'^api/accounts/(?P<slug>[\w-]+)/charts/tags$', 'accounts.views.api.accounts.charts.tags.tags', name='account_chart_tags'),
	url(r'^api/accounts/categories/(?P<slug>[\w-]+)/charts/statistics/$', 'accounts.views.api.categories.charts.statistics', name='category_charts_statistics'),
	url(r'^api/accounts/tags/(?P<slug>[\w-]+)/charts/statistics/$', 'accounts.views.api.tags.charts.statistics', name='tag_charts_statistics'),
