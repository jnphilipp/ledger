...
urlpatterns = patterns('',
	...
	url(r'^api/accounts/(?P<slug>[\w-]+)/charts/statistics/tags/$', 'accounts.views.api.accounts.charts.statistics.tags', name='account_charts_statistics_tags'),
	...
	url(r'^api/accounts/tag/(?P<slug>[\w-]+)/charts/statistics/$', 'accounts.views.api.tags.charts.statistics', name='tag_charts_statistics'),
